...
const CountryDetails = () => {
  ...
  return (
    <>
      <section className="border-t-2 h-[60vh] flex justify-center items-center">
        {data?.map((value, idx) => {
          return (
            <div key={idx} className="mt-28  group  flex justify-center items-center hover:scale-110 transition-all duration-200 ease-linear ">
                  ...
                  <section className=" w-full flex flex-col md:flex-row  justify-center gap-10 md:gap-16 items-start ">
                    ...
                    <div className="flex  flex-col justify-center items-start gap-4">
                      ...
                      <p>
                        <span className=" capitalize ">
                          {" "}
                         borders : <span className="inline-flex gap-4"> {value.borders.map((e) =>{
